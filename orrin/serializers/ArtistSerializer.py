...
class ArtistDetailSerializer(ArtistSerializer):
    ...
    def get_followers_count(self, obj):
        # obj.followers is the reverse relation of FollowedArtist.artist
        # each entry is a FollowedArtist row, so .count() is correct
    ...
    def get_is_following(self, obj):
        ...
        if not request or not request.user.is_authenticated:
            return False
        # FollowedArtist.artist reverse relation — filter by user FK
